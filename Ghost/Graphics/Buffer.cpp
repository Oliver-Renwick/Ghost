...
namespace graphics
{
	...
	void Buffer::Allocate(VkPhysicalDevice PhysicalDevice, VkDevice device, void* data, int size, VkBufferUsageFlagBits usageFlag, VkMemoryPropertyFlags memProps)
	{
		BufferSize = size;
		m_device = device;
